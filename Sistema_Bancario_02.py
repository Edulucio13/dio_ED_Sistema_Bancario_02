# importação da biblioteca para realizar o quebramento e preenchimento automático de texto
import textwrap
...
def main():
    ...
    AGENCIA = "0001" #Número da agência fixa em 0001
    ...
    usuarios = [] # Lista de usuarios vazio
    contas = [] # Lista de contas vazio
